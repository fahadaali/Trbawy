...
//
// هذا الملف مصدرٌ يُحرَّر هنا، لكنه **يُقدَّم للمتصفح من المسار `/service-worker.js`**
// بعد أن يختم فيه الـWorker بصمةَ النشر (انظر src/index.ts و src/lib/buildstamp.ts).
