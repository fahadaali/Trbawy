...
export const PERM_ROWS: PermRow[] = [
  ...
  },
  {
    ...
    hint: 'الحذف غير موجود في المنصة — البند يُلغى بحالته. والمكلَّف يتابع بنده بحكم إسناده إليه، '
      + 'ومنشئُ المهمة المستقلة يديرها بحكم إنشائه. و«إضافة بند» تشمل بنود المحاضر والمهام '
      + 'المستقلة معًا، ويبقى نطاق الإسناد بحسب الدور: الرئيس ونائبه للجميع، والمشرف الأول '
      + 'وعضو الفريق لأعضاء مجلس مرحلتهما',
  ...
  {
    key: 'files', label: 'الملفات التربوية',
    hint: 'النطاق يبقى بحسب مستوى المجلد: العام للجميع، ومجلد المجلس لمن يملك اطلاعه، والخاص لصاحبه. ورافعُ الملف يعدّله ويستبدله ويحذفه إلى السلة بحكم رفعه',
    actions: { view: 'اطلاع', add: 'رفع ملف وإنشاء مجلد', edit: 'إعادة تسمية واستبدال ونقل وتصنيف', delete: 'الحذف إلى السلة والحذف النهائي' },
  },
  {
